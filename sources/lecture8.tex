...
Additionally
\begin{align*}
\frac{1}{2^{\ell}} \sum_{i=0}^{2^\ell-1} a_{-t - i\frac{n}{2^\ell}} \omega^{-d i \frac{n}{2^\ell}} &= \frac{1}{2^\ell} \sum_{i=0}^{2^\ell-1} p(\omega^{t+i\frac{n}{2^\ell}}) \omega^{-d i \frac{n}{2^\ell}} \\
